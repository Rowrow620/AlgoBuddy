    ...
    fn recompute_steps(&mut self) {
        ...
        self.steps = match self.current_problem {
            ...
            Problem::ValidAnagram => generate_valid_anagram_steps(
                &self.valid_anagram_s_input,
                &self.valid_anagram_t_input,
                app_id,
            ),
            ...
            Problem::LongestSubstring => {
                let s = if self.palindrome_s_input.is_empty() {
                    "abcabcbb"
                } else {
                    &self.palindrome_s_input
                };
            ...
            Problem::MinWindowSubstring => {
                generate_min_window_substring_steps("ADOBECODEBANC", "ABC")
            }
            ...
            Problem::KokoEatingBananas => {
                ...
                let target_h = if self.binary_search_target_input <= 0 {
                    8
                } else {
                    self.binary_search_target_input
                };
                generate_koko_eating_bananas_steps(&piles, target_h)
            }
            Problem::ImplementTrie => {
                let insert_words: Vec<String> = self
                    .trie_words_input
                    .split(',')
                    .map(|s| s.trim().to_string())
                    .filter(|s| !s.is_empty())
            ...
            Problem::KClosestPoints => {
                generate_k_closest_points_steps(&[(1, 3), (-2, 2), (5, 8)], 1)
            }
            Problem::TaskScheduler => {
                generate_task_scheduler_steps(&['A', 'A', 'A', 'B', 'B', 'B'], 2)
            }
            ...
            Problem::CombinationSumII => {
                generate_combination_sum_ii_steps(&[10, 1, 2, 7, 6, 1, 5], 8)
            }
            ...
            Problem::WordLadder => generate_word_ladder_steps(
                "hit",
                "cog",
            ...
            Problem::DistinctSubsequences => {
                generate_distinct_subsequences_steps("rabbbit", "rabbit")
            }
    ...
    fn render_settings_modal(&mut self, ctx: &egui::Context) {
        ...
        egui::Window::new("⚙ AlgoBuddy UI Settings & Accessibility")
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    if ui
                        .selectable_label(self.theme == Theme::DarkVSCode, "VS Code Dark")
                        .clicked()
                    {
                        self.theme = Theme::DarkVSCode;
                    }
                    if ui
                        .selectable_label(self.theme == Theme::DarkCyber, "Cyber Navy")
                        .clicked()
                    {
                        self.theme = Theme::DarkCyber;
                    }
                    if ui
                        .selectable_label(self.theme == Theme::LightClean, "Clean Light")
                        .clicked()
                    {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.label(
                        RichText::new(self.colorblind_mode.label())
                            .color(p.emerald_text)
                            .strong(),
                    );
                });
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ...
                ui.columns(2, |cols| {
                    ...
                    egui::ScrollArea::vertical()
                        ...
                        .show(&mut cols[0], |ui| {
                            for &category in Category::all() {
                                let total_in_cat = self
                                    .visible_problems()
                                    .iter()
                                    .filter(|p| p.category() == category)
                                    .count()
                                    .max(1);
                                let solved_in_cat = self
                                    .visible_problems()
                                    .iter()
                                    .filter(|p| {
                                        p.category() == category
                                            && self.completed_problems.contains(&p.id())
                                    })
                                    .count();
                    ...
                    egui::ScrollArea::vertical().id_source("prob_scroll").show(
                        &mut cols[1],
                        |ui| {
                                ...
                                .show(ui, |ui| {
                                    for prob in self.visible_problems() {
                                        ...
                                        let mut is_completed =
                                            self.completed_problems.contains(&details.id);
                                        ...
                                        ui.label(
                                            RichText::new(details.category.name())
                                                .color(p.text_muted),
                                        );
                                        ui.end_row();
                                    }
            ...
            egui::SidePanel::left("roadmap_sidebar")
                ...
                .show(ctx, |ui| {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if ui
                            .selectable_label(self.selected_difficulty.is_none(), "All")
                            .clicked()
                        {
                        ...
                        if ui
                            .selectable_label(
                                ...
                                RichText::new("Med")
                                    .color(difficulty_color(Difficulty::Medium, &p)),
                            )
                            .clicked()
                        {
                            self.selected_difficulty = Some(Difficulty::Medium);
                    ...
                    egui::ScrollArea::vertical().show(ui, |ui| {
                        ...
                        let fav_problems: Vec<Problem> = self
                            .visible_problems()
                            .into_iter()
                            .filter(|p| self.favorite_problems.contains(&p.id()))
                            .filter(|p| {
                                if let Some(diff) = self.selected_difficulty {
                                    p.difficulty() == diff
                                } else {
                                    true
                                }
                        ...
                        egui::CollapsingHeader::new(
                            RichText::new(fav_header_text).color(p.amber).strong(),
                        )
                        .default_open(is_fav_active)
                        .show(ui, |ui| {
                            if fav_problems.is_empty() {
                                ui.label(
                                    RichText::new("  (No favorites starred yet)")
                                        .italics()
                                        .font(egui::FontId::proportional(11.0))
                                        .color(p.text_dim),
                                );
                        ...
                        let has_active_filter = !self.search_query.trim().is_empty()
                            || self.selected_difficulty.is_some();

                        for &category in Category::all() {
                            let problems_in_cat: Vec<Problem> = self
                                .visible_problems()
                                .into_iter()
                                .filter(|p| p.category() == category)
                                .filter(|p| {
                            ...
                            let total_in_cat = self
                                ...
                                .count();
                            let header_text =
                                format!("{} ({})", category.name(), problems_in_cat.len());
                                        ...
                                        ui.horizontal(|ui| {
                                                ...
                                                .clicked()
                                            {
                                                if is_fav {
                                                    ...
                                                    self.favorite_problems.insert(prob.id());
                                                }
                                            }

                                            let exp_tag =
                                                if prob.is_audited() { "" } else { " [EXP]" };
                                            ...
                                            let title_max_w =
                                                (ui.available_width() - 58.0).max(40.0);
                                            ui.scope(|ui| {
                                                ui.set_max_width(title_max_w);
                                                ui.style_mut().wrap_mode =
                                                    Some(egui::TextWrapMode::Truncate);
        ...
        egui::TopBottomPanel::top("header_panel")
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add(
                        egui::Slider::new(&mut self.current_step_idx, 0..=max_idx)
                            .show_value(false),
                    );
                    ...
                    match self.right_tab {
                            ...
                            if let Some(step) = self.steps.get(self.current_step_idx) {
                                ...
                                egui::ScrollArea::vertical()
                                    ...
                                    .show(ui, |ui| {
                                        ...
                                        if let Some(app_meta) = self
                                            .current_problem
                                            .details()
                                            .approaches
                                            .get(self.selected_approach_id)
                                        {
                        ...
                        RightTab::ProblemDetails => {
                            ...
                            egui::ScrollArea::vertical().show(ui, |ui| {
                                ...
                                ui.add_space(10.0);
                                ui.label(
                                    RichText::new("Description").strong().color(p.text_primary),
                                );
                                ui.add_space(4.0);
                                ui.label(
                                ...
                                ui.add_space(10.0);
                                ui.label(
                                    RichText::new("Constraints").strong().color(p.text_primary),
                                );
                                ui.add_space(4.0);
                                    ...
                                    egui::Frame::group(ui.style())
                                        ...
                                        .show(ui, |ui| {
                                            ...
                                            ui.label(
                                                RichText::new(format!(
                                                    "Time: {} | Space: {}",
                                                    app_meta.time_complexity,
                                                    app_meta.space_complexity
                                                ))
                                                .font(egui::FontId::monospace(11.0))
                                                .color(p.text_muted),
                                            );
